            ...
            <div class="col-xl-12 col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Content Pages</h6>
                  <span class="pull-right"><a href="<?php echo base_url(); ?>admin/contentpageadd">Add New</a></span>
                </div>
                <!-- Card Body -->
                <div class="card-body iframe-related">
                  
                <?php
                if($this->session->flashdata('content_page_save')){
                    ?>
                    <div class="alert alert-success col-lg-12">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>
                        <?php echo $this->session->flashdata('content_page_save'); ?></div>
                    <?php
                } ?>
                  <table class="table table-striped" id="contentpagetbl">
                <thead>
                  <tr>
                    <th>Title</th>
                    <th>Status</th>
                ...
                <tbody>
                     <?php foreach ($data as $d) { ?>      
                      ...
                      <td>
                         ...
                         <a class="btn btn-xs" href="<?php echo base_url('/admin/contentpagedit/'.$d->id) ?>"><i class="fa fa-edit"></i></a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary deletecontentlink" href="/admin/contentpagedelete/">Yes</a>
        </div>
      </div>
    </div>
  </div>
...
$(".deletecontentbtn").click(function(){
  $('.deletecontentlink').attr('href',baseUrl+"admin/contentpagedelete/"+$(this).attr('id'));
}); 
</script>
