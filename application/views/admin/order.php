                ...
                <tbody>
                     <?php foreach ($data as $d) { ?>      
                      <tr>
                          ...
                          <td><?php echo $d->rand_price; ?></td>
                          <td><?php echo $d->payment_status; ?></td>
                          <td><?php echo $d->transaction_id; ?></td>
                          <td><?php echo $d->slider_percent." %"; ?></td>
                          <td><?php echo $d->price_with_commission; ?></td>
                      <td>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary deleteOrderlink" href="/admin/deleteOrder/">Yes</a>
        </div>
      </div>
    </div>
  </div>
