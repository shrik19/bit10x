...
class Binance 
{
	...
	public function prices() {
	    //echo'<pre>';print_r($this->request("v1/ticker/allPrices"));exit;
	...
	//	return $this->signedRequest("v3/account");exit;
	}
